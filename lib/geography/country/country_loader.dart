...
class CountryQuizLoader extends StatefulWidget {

  static const routeName = '/countriesQuiz';

  CountryQuizLoader({Key key}) : super(key: key);
  @override
  _CountryQuizLoaderState createState() => _CountryQuizLoaderState();
}

class _CountryQuizLoaderState extends State<CountryQuizLoader> with SingleTickerProviderStateMixin{
          ...
          Column(
            children: [
              ...
              OutlineButton(
                ...
                onPressed: () {
                  Navigator.pushNamed(context, CountryQuestionsScreen.routeName);
                },
