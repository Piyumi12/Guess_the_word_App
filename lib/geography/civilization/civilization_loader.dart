...
class CivilizationQuizLoader extends StatefulWidget {

  static const routeName = '/countriesQuiz';

  CivilizationQuizLoader({Key key}) : super(key: key);
  @override
  _CivilizationQuizLoaderState createState() => _CivilizationQuizLoaderState();
}

class _CivilizationQuizLoaderState extends State<CivilizationQuizLoader> with SingleTickerProviderStateMixin{
          ...
          Column(
            children: [
              ...
              OutlineButton(
                ...
                onPressed: () {
                  Navigator.pushNamed(context, CivilizationQuestionsScreen.routeName);
                },
