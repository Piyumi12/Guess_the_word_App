...
import 'package:guess_the_word/quizPages/physics_question.dart';

class ViewPhysicsQuiz extends StatefulWidget {
  final QuizItem quiz;

  ViewPhysicsQuiz({this.quiz});

  @override
  State<StatefulWidget> createState() => _ViewPhysicsQuizState(quiz: this.quiz);
}

class _ViewPhysicsQuizState extends State<ViewPhysicsQuiz> {
  final QuizItem quiz;

  _ViewPhysicsQuizState({this.quiz});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                icon: Icon(Icons.add), onPressed: () => _createDialog(context))
          ],
        ),
          ...
          child: Padding(
            ...
            child: FloatingActionButton(
              onPressed: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => PhysicsQuestion(quiz: quiz))),
        ...
        body: ListView(children: activeWidgets));
  }
}
